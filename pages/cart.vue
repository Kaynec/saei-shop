<template>
  <main class="w-full mx-auto container p-4 py-8">
    <ClientOnly>
      <Dialog
      ...
      >
        ...
        <div class="flex justify-center gap-2">
          <Button @click="visible = false" class="flex-1" unstyled
            >انصراف</Button
          >
          <Button
    ...
    <MyCard class="flex flex-col-reverse lg:flex-row gap-4 min-h-[60vh]">
        ...
        <div class="flex flex-1 flex-col gap-4">
          <div class="w-full">
            <div class="flex items-center max-h-10 gap-2">
              <div
                class="text bg-grey-50 shadow-lg rounded w-9 h-9 flex-center"
              >
                <Icon
